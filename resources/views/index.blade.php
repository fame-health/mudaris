...
<head>
    ...
    <meta name="description"
        content="Mudaris Mandiri Wisata menyediakan paket umroh terpercaya dengan 15+ tahun pengalaman. 500+ jamaah puas, pelayanan 24/7, dan harga terjangkau. Daftar sekarang!">
    <meta name="keywords"
        content="paket umroh, umroh murah, travel umroh terpercaya, paket umroh 2025, umroh keluarga, umroh VIP, agen umroh resmi, Mudaris Mandiri Wisata, umroh jakarta, biaya umroh">
    ...
    <section id="paket" class="py-20 bg-white">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach (App\Models\Paket::active()->get() as $paket)
                    ...
                    <div
                        class="card-hover bg-white rounded-3xl p-8 shadow-lg relative overflow-hidden fade-in border-2
        {{ $paket->is_featured ? 'transform scale-105 border-yellow-400' : $categoryColors['border'] }}">
                        ...
                        <div class="relative">
                            <!-- Image Container -->
                            <div
                                class="max-w-[1587px] w-full aspect-[1587/2245] mx-auto rounded-xl overflow-hidden mt-8 border shadow">
                            ...
                            <div
                                class="w-16 h-16 bg-gradient-to-br from-{{ $categoryColors['gradient']['from'] }} to-{{ $categoryColors['gradient']['to'] }} rounded-2xl flex items-center justify-center mb-6 absolute -top-8 left-6 shadow-md">
                            ...
                            <div
                                class="flex items-center justify-between mb-6 p-3 {{ $categoryColors['bg_accent'] }} rounded-lg border border-opacity-20 {{ $categoryColors['border'] }}">
                                <!-- Hotel Rating -->
                            ...
                            <!-- Harga -->
                            <div
                                class="text-center mb-4 p-4 {{ $categoryColors['bg_accent'] }} rounded-lg border border-opacity-20 {{ $categoryColors['border'] }}">
                            ...
                            <!-- Button Full Width -->
                            <button
                                onclick="sendWhatsApp('{{ $paket->name }}', '{{ $paket->formatted_price }}', '{{ $paket->duration_days ?? 14 }}', '{{ $paket->hotel_rating ?? 4 }}', '{{ $categoryColors['category_name'] }}')"
...
Mohon informasi lebih lanjut, terima kasih.`;
    ...
    <!-- Media Section -->
    <!-- Media Section -->
    <section id="{{ $section->id ?? 'media' }}"
        class="py-20 {{ $section->background_color ?? 'bg-gradient-to-br from-gray-50 to-gray-100' }}">
        <div class="max-w-6xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                <h2
                    class="text-4xl font-bold mb-4 {{ $section->title_color ?? 'bg-gradient-to-r from-yellow-600 to-orange-600 bg-clip-text text-transparent' }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-{{ $section->columns ?? 3 }} gap-6 fade-in">
                @foreach ($mediaItems as $media)
                    <div
                        class="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                        ...
                        <div class="relative w-full aspect-[9/16] bg-gray-100 overflow-hidden">
                            ...
                            @elseif($media->type === 'youtube')
                                ...
                                <div class="relative w-full h-full group cursor-pointer"
                                    onclick="loadYouTubeVideo(this, '{{ $media->embed_id }}')">
                                    <!-- Thumbnail YouTube -->
                                    <img src="https://img.youtube.com/vi/{{ $media->embed_id }}/maxresdefault.jpg"
                                        alt="YouTube Video Thumbnail" class="w-full h-full object-cover" />
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="bg-red-600 rounded-full p-3 shadow-lg transform group-hover:scale-110 transition-transform duration-200">
                            ...
                            @elseif($media->type === 'tiktok')
                                ...
                                <div class="relative w-full h-full group cursor-pointer"
                                    onclick="loadTikTokVideo(this, '{{ $media->embed_id }}')">
                                    ...
                                    <div
                                        ...
                                        <div class="text-center text-white">
                                            <svg class="w-16 h-16 mx-auto mb-2" fill="currentColor"
                                                viewBox="0 0 24 24">
                                                <path
                                                    d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-.88-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43V7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04.57z" />
                                            </svg>
                                    ...
                                    <!-- Overlay dengan tombol play -->
                                    <div
                                        class="absolute inset-0 bg-black bg-opacity-20 flex items-center justify-center group-hover:bg-opacity-30 transition-all duration-200">
                                        <div
                                            class="bg-black bg-opacity-60 rounded-full p-3 shadow-lg transform group-hover:scale-110 transition-transform duration-200">
                                            <svg class="w-8 h-8 text-white ml-1" fill="currentColor"
                                                viewBox="0 0 24 24">
                                                <path d="M8 5v14l11-7z" />
                                            </svg>
                                    ...
                                    <!-- Label TikTok -->
                                    <div
                                        class="absolute top-2 right-2 bg-black text-white px-2 py-1 rounded text-xs font-medium">
                                        TikTok
                                    </div>
                                </div>
                            @elseif($media->type === 'instagram')
                                ...
                                <div class="relative w-full h-full group cursor-pointer"
                                    onclick="loadInstagramPost(this, '{{ $media->embed_id }}')">
                                    ...
                                    <!-- Label Instagram -->
                                    <div
                                        class="absolute top-2 right-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white px-2 py-1 rounded text-xs font-medium">
                                        Instagram
                                    </div>
                                </div>
                            @endif
                        ...
                        @if (!empty($media->title) || !empty($media->alt_text))
                            <div class="p-4 {{ $section->caption_background ?? 'bg-white' }}">
                                @if (!empty($media->title))
                                    <h3
                                        class="font-semibold {{ $section->caption_text_color ?? 'text-gray-800' }} mb-1">
                                        {{ $media->title }}</h3>
                                @endif
                                @if (!empty($media->alt_text))
                                    <p class="text-sm {{ $section->caption_text_color ?? 'text-gray-600' }}">
                                        {{ $media->alt_text }}</p>
                                @endif
                            </div>
                        @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach (App\Models\Testimonial::active()->limit(6)->get() as $testimonial)
                    <div class="fade-in">
                        ...
                        <div
                            class="bg-gradient-to-br {{ $randomGradient['from'] }} {{ $randomGradient['to'] }} p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                            <div class="flex items-center mb-4">
                                @if ($testimonial->avatar)
                                    <img src="{{ $testimonial->avatar_url }}" alt="{{ e($testimonial->name) }}"
                                        class="w-12 h-12 rounded-full object-cover">
                                @else
                                    <div
                                        class="w-12 h-12 bg-gradient-to-br {{ $randomGradient['avatarFrom'] }} {{ $randomGradient['avatarTo'] }} rounded-full flex items-center justify-center">
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center text-white fade-in">
                    <div
                        class="w-20 h-20 bg-white bg-opacity-20 rounded-2xl flex items-center justify-center mx-auto mb-6 backdrop-blur-sm">
                    ...
                    <div class="space-y-8">
                        ...
                        @if ($contact)
                            <div class="flex items-start space-x-4">
                                <div
                                    class="w-12 h-12 gradient-bg rounded-xl flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    @if ($contact->monday_friday_hours)
                                        <p class="text-gray-600">Senin - Jumat: {{ $contact->monday_friday_hours }}
                                        </p>
                                    @endif
                                ...
                                <div class="flex space-x-4">
                                    ...
                                    @if ($contact->whatsapp_link)
                                        <a href="{{ $contact->whatsapp_link }}" target="_blank"
                                            class="w-12 h-12 bg-green-600 rounded-xl flex items-center justify-center text-white hover:bg-green-700 transition-colors">
                ...
                <div class="fade-in">
                    <div class="bg-white rounded-3xl shadow-xl p-8">
                        ...
                        <form id="contactForm" class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Paket yang Diminati
                                    *</label>
                                <select name="package_interest" id="package_interest" required
                                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300">
                            ...
                            <button type="submit" id="submitButton"
                                class="w-full gradient-bg text-white py-4 rounded-xl font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-300">
                                <span id="buttonText">
